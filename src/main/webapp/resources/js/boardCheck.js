...
let writer = document.getElementById('inputNickname');
let title = document.getElementById('inputName');
let text = document.getElementById('inputBirth');
let file = document.getElementById('inputEmail');
